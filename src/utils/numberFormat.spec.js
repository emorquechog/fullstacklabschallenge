import {getCurrencyFormattedNumber, isInt, scrubFormatting, getFormattedNumber, addZeros} from './numberFormat';
...
describe('Number Formatter', () => {
  ...
  describe('addZeros', () => {
    it('add zeros at the left of the number', () => {
      expect(addZeros(3, 3)).toEqual('003');
    });
  });
});
